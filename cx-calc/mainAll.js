...
// tips ------------------
    ...
    const allTips = [
        ...
        },
        {
            ...
            text: 'История.<br>Задръжте бутона за отваряне на <b>Настройки</b> (на компютър: Ctrl+Клик).  От <b>Настройки</b> може да определите позицията и размера на калкулатора, така че да е максимално удобен за работа. Може да зададете и предпочитания за работа с дясна или лява ръка.',
